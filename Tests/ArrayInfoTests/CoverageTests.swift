...
final class CoverageTests : XCTestCase {
    func testCoverage() {
        ...
        do {
			...
			XCTAssertEqual(s.constantExactDelta, Optional(2))
			XCTAssertEqual(s.median, Optional(2.0))
			XCTAssertEqual(s.histogram, Optional([3: 1, 1: 1]))
			XCTAssertEqual(s.mode, nil)
        }
        ...
        do {
			...
			XCTAssertEqual(s.constantExactDelta, Optional(2))
			XCTAssertEqual(s.median, Optional(2.0))
			XCTAssertEqual(s.histogram, Optional([1.0: 1, 3.0: 1]))
			XCTAssertEqual(s.mode, nil)
        }
        ...
        do {
			...
			XCTAssertEqual(s.constantExactDelta, Optional(1))
			XCTAssertEqual(s.median, Optional(2.0))
			XCTAssertEqual(s.histogram, Optional([2: 1, 3: 1, 1: 1]))
			XCTAssertEqual(s.mode, nil)
        }
        ...
        do {
            let a = Array<Float16>([1.0, 2.0, 3.0])
            let s = a.info(ArrayInfo<Float16>.Options(rawValue: 0))
            XCTAssertEqual(s.issues, [])
			XCTAssertEqual(s.count, 3)
			XCTAssertEqual(s.isEmpty, false)
        ...
        do {
			...
			XCTAssertEqual(s.constantExactDelta, Optional(1))
			XCTAssertEqual(s.median, Optional(2.0))
			XCTAssertEqual(s.histogram, Optional([3.0: 1, 1.0: 1, 2.0: 1]))
			XCTAssertEqual(s.mode, nil)
        }
        ...
        do {
			...
			XCTAssertEqual(s.constantExactDelta, nil)
			XCTAssertEqual(s.median, Optional(6.0))
			XCTAssertEqual(s.histogram, Optional([8: 1, 2: 1, 16: 1, 4: 1]))
			XCTAssertEqual(s.mode, nil)
        }
        ...
        do {
			...
			XCTAssertEqual(s.constantExactDelta, nil)
			XCTAssertEqual(s.median, Optional(6.0))
			XCTAssertEqual(s.histogram, Optional([8.0: 1, 4.0: 1, 16.0: 1, 2.0: 1]))
			XCTAssertEqual(s.mode, nil)
        }
        ...
        do {
			...
			XCTAssertEqual(s.constantExactDelta, nil)
			XCTAssertEqual(s.median, Optional(1.0))
			XCTAssertEqual(s.histogram, Optional([2: 2, 0: 1, 1: 2]))
			XCTAssertEqual(s.mode, Optional([1, 2]))
        }

        do {
            let a = Array<Float16>([-1.1, 2.51, 0.01])
            let s = a.info(ArrayInfo<Float16>.Options(rawValue: 1))
            XCTAssertEqual(s.issues, [])
			XCTAssertEqual(s.count, 3)
			XCTAssertEqual(s.isEmpty, false)
			XCTAssertEqual(s.sum, Optional(1.4201583862304688))
			XCTAssertEqual(s.exactSum, nil)
			XCTAssertEqual(s.exactSumOverflow, false)
			XCTAssertEqual(s.elementOverflow, false)
			XCTAssertEqual(s.allElementsEqual, false)
			XCTAssertEqual(s.avg, Optional(0.47338612874348956))
			XCTAssertEqual(s.minValue, Optional(-1.1))
			XCTAssertEqual(s.maxValue, Optional(2.51))
			XCTAssertEqual(s.minValueIndex, Optional(0))
			XCTAssertEqual(s.maxValueIndex, Optional(1))
			XCTAssertEqual(s.exactMinDelta, nil)
			XCTAssertEqual(s.exactMaxDelta, nil)
			XCTAssertEqual(s.minDelta, Optional(2.4997634887695312))
			XCTAssertEqual(s.maxDelta, Optional(3.609375))
			XCTAssertEqual(s.avgDelta, Optional(3.0545692443847656))
			XCTAssertEqual(s.exactSumDelta, nil)
			XCTAssertEqual(s.sumDelta, Optional(6.109138488769531))
			XCTAssertEqual(s.exactSumDeltaOverflow, false)
			XCTAssertEqual(s.exactMinMaxDeltaOverflow, false)
			XCTAssertEqual(s.isAscending, false)
			XCTAssertEqual(s.isStrictlyAscending, false)
			...
			XCTAssertEqual(s.constantExactDelta, nil)
			XCTAssertEqual(s.median, nil)
			XCTAssertEqual(s.histogram, Optional([-1.1: 1, 0.01: 1, 2.51: 1]))
			XCTAssertEqual(s.mode, nil)
        }

        do {
            let a = Array<Float16>([-1.1, 2.51, 0.01])
            let s = a.info(ArrayInfo<Float16>.Options(rawValue: 2))
            XCTAssertEqual(s.issues, [])
			XCTAssertEqual(s.count, 3)
			XCTAssertEqual(s.isEmpty, false)
			XCTAssertEqual(s.sum, Optional(1.4201583862304688))
        ...
        do {
            let a = Array<Float16>([-1.1, 2.51, 0.01])
            let s = a.info(ArrayInfo<Float16>.Options(rawValue: 3))
            XCTAssertEqual(s.issues, [])
			XCTAssertEqual(s.count, 3)
			XCTAssertEqual(s.isEmpty, false)
			XCTAssertEqual(s.sum, Optional(1.4201583862304688))
        ...
        do {
            let a = Array<Float16>([-1.1, 0.01, 2.51])
            let s = a.info(ArrayInfo<Float16>.Options(rawValue: 3))
            XCTAssertEqual(s.issues, [])
			XCTAssertEqual(s.count, 3)
			XCTAssertEqual(s.isEmpty, false)
			...
			XCTAssertEqual(s.exactMinDelta, nil)
			XCTAssertEqual(s.exactMaxDelta, nil)
			XCTAssertEqual(s.minDelta, Optional(1.1096115112304688))
			XCTAssertEqual(s.maxDelta, Optional(2.4997634887695312))
			XCTAssertEqual(s.avgDelta, Optional(1.8046875))
			XCTAssertEqual(s.exactSumDelta, nil)
			XCTAssertEqual(s.sumDelta, Optional(3.609375))
			XCTAssertEqual(s.exactSumDeltaOverflow, false)
			XCTAssertEqual(s.exactMinMaxDeltaOverflow, false)
			XCTAssertEqual(s.isAscending, true)
			XCTAssertEqual(s.isStrictlyAscending, true)
			...
			XCTAssertEqual(s.hasConstantExactDelta, false)
			XCTAssertEqual(s.constantExactDelta, nil)
			XCTAssertEqual(s.median, Optional(0.01000213623046875))
			XCTAssertEqual(s.histogram, Optional([-1.1: 1, 0.01: 1, 2.51: 1]))
			XCTAssertEqual(s.mode, nil)
        }
    }
